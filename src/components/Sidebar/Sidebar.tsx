                ...
                <div className="logo_img">
                    {
                        (valueOpen)
                            ? <>
                                ...
                                <img src={close2} alt="" className='closeSidebarButton' onClick={() => { handleOpen(1) }} />
                            </>
                            : <>
            ...
            <ul className="nav-links" onClick={() => { handleOpen(2) }}>
                {routesValue.map((route, index) => (
                    (!route.dropdown)
                        ...
                        : <LinksWithDropDown route={route} indexMenu={index} onHandleMenu={handleClickMenu} key={route.name} />
                ))}
            </ul>

            <div className="profile-details" onClick={() => { handleOpen(2) }}>
