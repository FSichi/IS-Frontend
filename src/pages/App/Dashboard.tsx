    ...
    return (
        <div className="min-w-full overflow-hidden rounded-lg shadow mt-5 overflow-x-auto">
            <table className="min-w-full">
                <thead>
                    <tr>
                        <th scope="col" className="px-5 py-3 text-sm font-medium text-left text-gray-100 uppercase bg-gray-900 border-b border-gray-400">
                            Agencia
                        </th>
                        <th scope="col" className="px-5 py-3 text-sm font-medium text-center text-gray-100 uppercase bg-gray-900 border-b border-gray-400">
                            Casos
                        </th>
                        <th scope="col" className="px-5 py-3 text-sm font-medium text-center text-gray-100 uppercase bg-gray-900 border-b border-gray-400">
                            Clientes
        ...
        <div className="mt-4">
            ...
            <div className="py-4">
                ...
                <div className="w-full h-2 bg-gray-300 rounded-full mt-3">
                    <div className="w-2/5 h-full bg-indigo-300 rounded-full">
                    </div>
                </div>
            </div>
            ...
            <div className="py-4">
                ...
                <div className="w-full h-2 bg-gray-300 rounded-full mt-3">
                    <div className="w-1/3 h-full bg-red-300 rounded-full">
                    </div>
                </div>
            </div>
            ...
            <div className="py-4">
                ...
                <div className="w-full h-2 bg-gray-300 rounded-full mt-3">
                    <div className="w-1/4 h-full bg-amber-300 rounded-full">
                    </div>
                </div>
            </div>
