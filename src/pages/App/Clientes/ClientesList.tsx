...
export const ClientesList = () => {
    ...
    const onChangeCurrent = (value: number) => { setCurrent(value); }
    ...
    return (
        <section className="p-5">
            ...
            {(openModalNewCliente) && <PopupModal openValue={openModalNewCliente} closeFunction={onCloseModal} />}
            ...
            <PaginationSection current={current} changeCurrent={onChangeCurrent} pageSize={10} totalElements={100} />
