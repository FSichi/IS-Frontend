...
import { ceseOptions, contratoOptions, empresaOptions, pageSizeOptions } from "../../../data/select/selectOptions"
...
export const FiltersSection = ({ setFilterData }: Props) => {
    ...
    return (
        <form onSubmit={onSubmit} className="bg-gray-700 rounded-md mt-5 2xl:flex 2xl:justify-between"> {/* 2xl:w-10/12 */}
            ...
            <div className="p-6 grid grid-cols-3 gap-4">
                ...
                <TextInput
                    inputName={'cuit'} inputType={'string'} inputTitle={'Cuit/Cuil'}
            ...
            <div className="bg-gray-800 px-4 py-3 2xl:w-40 sm:px-6 rounded-md flex justify-between 2xl:block">
                ...
                <SelectInput
                    inputName={'pageSize'} options={pageSizeOptions}
                    registerForm={{ ...register("pageSize", { required: false }) }}
                    customContainerClassName="w-28" customInputClassName="text-center"
                />

                <div>
                    <ActionButton
                        type="submit" title="Restablecer" action={resetFilters}
